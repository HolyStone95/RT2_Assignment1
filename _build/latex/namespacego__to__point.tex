...
\begin{DoxyVerb}This Callback is for the subscriber to topic ``odom``
...
\begin{DoxyVerb}This Callback is for the subscriber to topic ``cmd_vel_filter``
...
\begin{DoxyVerb}This function initializes the ROS node and the action server,
